...
<div class="wrapper">
  ...
  <div class="page-content">
    <div class="content container">
      <div class="row">
        <div class="col-lg-12">
          <h2 class="page-title">صفحه ها<small>  تغییر متن  قوانین و مقررات</small></h2>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12">
		...
		<form  name="frm_laws"  method="POST" action=""   >       
                <fieldset>
			...
			<textarea  class="form-control" id="page_text" name="page_text"><?php echo $row['txt'];  ?></textarea> 
                    ...
                    <div class="controls form-group">					
                        ...
                        <i data-backdrop="false" data-target="#messagebox" data-toggle="modal" class="btn btn-warning pull-left" type="botton" class="btn_laws" id="btn_laws" name="btn_laws">    ثبت تغییرات    </i>
                        
                        
<!--			<button  data-backdrop="false" data-target="#messagebox" data-toggle="modal" class="btn btn-warning pull-left" name="btn_about" class="btn_about" id="btn_about" type="button"> ثبت تغییرات </button>                         -->
                    </div>
                  </div>
...
<script type="text/javascript">     
          $(document).ready(function() {
                ...
                $("#btn_laws").click(function() {
                    
                    $btn_laws_post = this.id;     
                       
                    $page_title =  document.forms["frm_laws"]["page_title"].value;
                    ...
                    $.ajax({                       
                        url: 'ajax.php',
                        type: 'POST',
                        data: ({btn_page_post: $btn_laws_post , page_title : $page_title , page_text : $page_text , page_pic : $page_pic , page_type : $page_type}),

...
function deleteimage(large_image, thumbnail_image){
	loadingmessage('ÈÑÇí ÍÐÝ ÊÕæíÑ ÈÒÑ äÏ áÍÙå ãäÊÙÑ ÈãÇäíÏ...', 'show');
	$.ajax({
		type: 'POST',
...
$(document).ready(function () {
	...
	$('#save_thumb').click(function() {
		...
		var h = $('#h').val();
		if(x1=="" || y1=="" || x2=="" || y2=="" || w=="" || h==""){
			alert("ÔãÇ ÇÈÊÏÇ ÈÇíÏ í˜ ÊÕæíÑ ÇäÊÎÇÈ äãÇííÏ");
			return false;
		}else{
			...
			$.ajax({
				...
				success: function(response){
					...
					if(responseType=="success"){
						...
						$('#uploaded_image').html('<img src="'+responseThumbImage+'" alt="Thumbnail Image"/><br />   <a href="javascript:deleteimage(\''+responseLargeImage+'\');">Delete Images</a>');
...
//]]>
	...
	<p><a id="upload_link" style="background:#39f; font-size: 24px; color: white;" href="#">select </a></p>
	...
	<div id="thumbnail_form" style="display:none;">
		<form name="form" action="" method="post">
			...
			<input type="submit" name="save_thumb" value="save thumb" id="save_thumb" />
		</form>
	</div>

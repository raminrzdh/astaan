...
<div class="wrapper">
  ...
  <div class="page-content">
    <div class="content container">
      <div class="row">
        <div class="col-lg-12">
          <h2 class="page-title">صفحه ها<small>  تغییر متن صفحه تماس با ما </small></h2>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12">
		...
		<form  name="frm_contactus"  method="POST" action=""   >       
                <fieldset>
			...
			<textarea  class="form-control" id="page_text" name="page_text"><?php echo $row['txt'];  ?></textarea> 
                    ...
                    <div class="controls form-group">					                        
                        <i data-backdrop="false" data-target="#messagebox" data-toggle="modal" class="btn btn-warning pull-left" type="botton" class="btn_contactus" id="btn_contactus" name="btn_contactus">    ثبت تغییرات     </i>
                    </div>
                  </div>                  
                </fieldset>	
                </form>												 
...
<script type="text/javascript">     
          $(document).ready(function() {
                ...
                $("#btn_contactus").click(function() {
                    ...
                    $btn_contactus_post = this.id;     
                       
                    $page_title =  document.forms["frm_contactus"]["page_title"].value;
                    ...
                    $.ajax({                       
                        url: 'ajax.php',
                        type: 'POST',
                        data: ({btn_page_post: $btn_contactus_post , page_title : $page_title , page_text : $page_text , page_pic : $page_pic , page_type : $page_type}),
